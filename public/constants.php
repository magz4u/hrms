...
defined('MANAGE_MODULE_ARRAY')|| define('MANAGE_MODULE_ARRAY', serialize (array(TIMEMANAGEMENT,RESOURCEREQUISITION,BGCHECKS,REPORTS,SERVICEDESK,PERFORMANCEAPPRAISAL)));/*hmtech*/
// Employee documents
...
defined('ATTENDANCESTATUSCODE_DELETE')|| define('ATTENDANCESTATUSCODE_DELETE', 'attendance status code');/*hmtech*/
...
defined('ATTENDANCE_MEDIA_PATH') || define('ATTENDANCE_MEDIA_PATH', $domainurl.'/public/media/attendance/');/*hmtech*/
...
defined('ATTENDANCE_DELETE')|| define('ATTENDANCE_DELETE','attendance');/*hmtech*/
