...
class Zend_View_Helper_Menubuilder extends Zend_View_Helper_Abstract {
	...
	**/
	...
	/*	if(isset($act_menus[ASSETS]) && $act_menus[ASSETS]['isactive'] == 1 && $usergroup!=USERS_GROUP)
		...
		if(($userRole == SUPERADMIN || $usergroup == MANAGEMENT_GROUP && $userRole == EMPLOYEE || $usergroup == EMPLOYEE_GROUP) && $con != 'settings')
		{
            ...
            **** END ****/
			 ...
			 $parent_menu .= "<li selected-class='log-selected' id='main_parent_logs'  class='clickable_menu log-selected-main tour_logs' menu-url='http://localhost/hmtech/index.php/attendance/' for-childs = 'div_mchilds_logs'><b>Attendance</b></li>";
