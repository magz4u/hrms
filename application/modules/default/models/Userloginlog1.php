...
class Default_Model_Userloginlog1 extends Zend_Db_Table_Abstract
{
	...
	public function getUserLoginLogGrid($sort,$by,$perPage,$pageNo,$searchData,$call,$p1,$p2,$p3,$p4,$p5)
	{
		...
		$tableFields = array('action'=>'Action',
                             ...
                             'logindatetime' => 'Checkin',
                             'loginoutdatetime' => 'Checkout',
                             'empipaddress' => 'Location',
		                     /*'empipaddress' => 'Ip Address1',*/


		);

		$tablecontent = $this->getUserLoginLog1Data($sort, $by, $pageNo, $perPage,$searchQuery);

		$group_data = $group_model->getGroupsListForUserLoginLog1();
		$group_arr = array();
		...
		$role_data = $role_model->getRoleListForUserLoginLog1();
		$role_arr = array();
