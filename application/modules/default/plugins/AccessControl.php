...
protected function _getAcl()
{
    ...
    $acl->addResource(new Zend_Acl_Resource('default:userloginlog1'));
   $acl->allow('admin', 'default:userloginlog1', array('index'));


	   /*Adding ACL for Attendance Module */


	    $acl->addResource(new Zend_Acl_Resource('attendance:checkinuser'));
	               $acl->allow('admin', 'attendance:checkinuser', array('checkin','handlecheckin'));

                // $acl->addResource(new Zend_Acl_Resource('Restapi:tbl_emploginlog'));
           	        //     $acl->allow('admin', 'Restapi:tbl_emploginlog', array('tbl_emploginlog','tbl_emploginlog_employeeId')));


	   // $acl->addResource(new Zend_Acl_Resource('Restapi'));
//$acl->allow('admin', 'Restapi',array('tbl_emploginlog'));


	   /*end of ACL for Attendance module */
      ...
      $acl->addResource(new Zend_Acl_Resource('attendance:checkinuser'));
	    ...
	    $acl->addResource(new Zend_Acl_Resource('attendance:checkinuser'));
	               $acl->allow('manager', 'attendance:checkinuser', array('checkin','handlecheckin'));

	    //  $acl->addResource(new Zend_Acl_Resource('attendance:checkoutuser'));
	    //            $acl->allow('manager', 'attendance:checkoutuser', array('checkout','handlecheckout'));
	     ...
	     $acl->addResource(new Zend_Acl_Resource('attendance:checkinuser'));
	               $acl->allow('hrmanager', 'attendance:checkinuser', array('checkin','handlecheckin'));

	    //  $acl->addResource(new Zend_Acl_Resource('attendance:checkoutuser'));
	    //            $acl->allow('hrmanager', 'attendance:checkoutuser', array('checkout','handlecheckout'));
	     ...
	     $acl->addResource(new Zend_Acl_Resource('attendance:checkinuser'));
	               $acl->allow('employee', 'attendance:checkinuser', array('checkin','handlecheckin'));

	    //  $acl->addResource(new Zend_Acl_Resource('attendance:checkoutuser'));
	    //            $acl->allow('employee', 'attendance:checkoutuser', array('checkout','handlecheckout'));
